...
//		session.setAttribute("user_id", requestMessage.getParameter("user_id"));
		session.setAttribute("lti_pass", true);
		
//		LOG.info("user_id = " + session.getAttribute("user_id"));
//		LOG.info("lti_request = " + session.getAttribute("lti_request"));
	}
